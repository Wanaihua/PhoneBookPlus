  ...
  $(document).ready(function() {
   ...
   <%
       if(request.getAttribute("who")!=null){
         int id=Integer.parseInt(request.getAttribute("who").toString());
         if(id==0){
          %>
  ...
  <div class="body">
   ...
   <form action="/login.do" method="post" name="form1" id="form1" >
    ...
    <div class="inputt">
     ...
     <input name="userName" class="inputtt" id="usename" placeholder="用户名"/>
    </div>

    <div class="inputt">
     <input name="userPass" type="password" id="password" class="inputtt" placeholder="密码"/>
   ...
   <a class="txt2" href="${pageContext.request.contextPath}/user_register.jsp">
    注册
   </a>
  </div>
 </div>
